...
export function SearchableCompanySelect({ companies, value, onChange, includeAll = false, allLabel = "Tüm firmalar", invalid = false }: { companies: Company[]; value: number | string | null; onChange: (value: number | string | null) => void; includeAll?: boolean; allLabel?: string; invalid?: boolean }) {
