...
export function VisualFilterSurface({
  ...
  return (
    <section className={cn("visual-filter-surface relative isolate overflow-hidden rounded-2xl border border-sidebar-border bg-sidebar p-3 shadow-primary sm:p-4", className)}>
